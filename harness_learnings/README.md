...
This folder is the working knowledge base for building and maintaining coding harnesses.

## Read Order

1. `coding-harness-best-practices.md` for the canonical setup guidance.
...
- `coding-harness-best-practices.md` is the main canon.
...
Use this folder to:
- evolve `project_agnostic_claude_setup/`
- compare upstream harness ideas without re-reading whole repos
- keep the final guidance separate from raw source material

Keep this folder concise. Add synthesized learnings, not repo dumps.
